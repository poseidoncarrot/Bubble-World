  ...
  const editor = useEditor({
    extensions: [
      ...
      Placeholder.configure({
        placeholder: placeholder || 'Start writing your worldbuilding content here...',
      }),
    ...
    return (
      <div className="flex items-center justify-center h-full">
        <div className="text-center">
          ...
          <h3 className="text-lg font-semibold text-on-surface mb-2">No Page Selected</h3>
          <p className="text-sm text-on-surface-variant">Select a page from the sidebar to start editing</p>
        </div>
      </div>
    );
  }
