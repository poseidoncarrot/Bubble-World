...
import { Page, World, PageConnection } from '@/types';
...
export const BubbleMap: React.FC<BubbleMapProps> = ({
  ...
  const bubbleNodes = pages.map(page => ({
    id: page.id,
    title: page.title,
    type: page.parent_page_id ? 'subsection' as const : 'main' as const,
